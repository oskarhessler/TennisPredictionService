...
public class TennisPredictionApp {
    ...
    /**
     * Convert Match to double array format expected by extractFeatures
     * You'll need to implement this based on what your extractFeatures actually expects
     */
    private static double[] convertMatchToDoubleArray(Match match) {
        // This is a placeholder - you need to implement based on what format your extractFeatures expects
        // Common possibilities:

        // Option 1: Basic match info
        // return new double[] {
        //     match.getWinner().getRank(),
        //     match.getLoser().getRank(),
        //     match.getTourneyDate(),
        //     // ... other basic match data
        // };

        // Option 2: Raw player stats
        // return new double[] {
        //     match.getWinner().getPoints(),
        //     match.getLoser().getPoints(),
        //     match.getWinner().getAge(),
        //     match.getLoser().getAge(),
        //     // ... other player attributes
        // };

        // For now, return null to avoid compilation error
        // You need to replace this with the actual conversion logic
        System.out.println("WARNING: convertMatchToDoubleArray not implemented - please implement based on your extractFeatures input format");
        return null;
    }
